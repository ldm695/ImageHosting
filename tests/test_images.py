...
from conftest import upload_png, make_png
...
def test_batch_move(client):
    ...
    upload_png(client, 'a.png')
    upload_png(client, 'b.png')
    r = client.post('/api/images/batch-move',
                    json={'group': Config.DEFAULT_GROUP, 'to_group': 'dest',
...
def test_batch_tag(client):
    upload_png(client, 'a.png')
    upload_png(client, 'b.png')
    r = client.post('/api/images/batch-tag',
                    json={'group': Config.DEFAULT_GROUP, 'tag': 'batch',
                          'files': ['a.png', 'b.png']})
...
def test_batch_delete(client):
    upload_png(client, 'a.png')
    r = client.post('/api/images/batch-delete',
                    json={'group': Config.DEFAULT_GROUP, 'files': ['a.png']})
